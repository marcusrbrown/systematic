...
Always include:
- `systematic:coherence-reviewer`
- `systematic:feasibility-reviewer`

Add activated conditional personas:
- `systematic:product-lens-reviewer`
- `systematic:design-lens-reviewer`
- `systematic:security-lens-reviewer`
- `systematic:scope-guardian-reviewer`
- `systematic:adversarial-document-reviewer`

...
| `review-artifact-path.ts` | `ArtifactPathResult`, `hasParentDirectoryTraversal`, `pathContainsSymlink`, `resolveReviewArtifactPath` | Cwd-anchored containment checks for review artifact paths, shared by the CLI and Claude Code validator entry |

...
- Happy path: extraction through the nullable `anyOf` wrapper reaches the `modelSchema` definition's own `examples: ['anthropic/claude-sonnet-5', null]` entry.

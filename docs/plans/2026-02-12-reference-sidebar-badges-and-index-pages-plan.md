---
title: 'Reference Sidebar Badges & Index Pages — Implementation Plan'
type: feat
status: completed
date: 2026-02-12
...
> **Status: completed.** Reference index pages now use Starlight's `LinkCard` + `CardGrid` components (auto-generated by `docs/scripts/transform-content.ts`); sidebar badges are emitted as category-based metadata for agents per the reference-section-refresh plan.

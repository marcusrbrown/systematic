...
- Create: `scripts/lib/opencode-availability.ts` (the shared classification helper: probe and classify; it never throws — the `SYSTEMATIC_REQUIRE_OPENCODE` decision belongs to each test module's scope)

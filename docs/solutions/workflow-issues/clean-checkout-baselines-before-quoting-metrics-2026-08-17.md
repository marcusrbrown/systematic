...
- [`docs/solutions/workflow-issues/host-contract-evidence-is-ci-owned-2026-09-04.md`](host-contract-evidence-is-ci-owned-2026-09-04.md) — adjacent: evidence invalidated by a moving pin rather than by working-directory state.

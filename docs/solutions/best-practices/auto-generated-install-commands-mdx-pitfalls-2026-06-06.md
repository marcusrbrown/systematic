...
- `docs/solutions/test-failures/unguarded-generator-main-repairs-drift-when-imported-by-tests-2026-07-28.md` — the same `import.meta.main` guard, framed as a drift-masking failure: without it, importing the generator from its test silently repairs drift and defeats the `--check` gate.

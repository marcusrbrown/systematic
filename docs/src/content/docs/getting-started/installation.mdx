---
title: Installation
description: Add Systematic to OpenCode in one step — install the plugin, restart, and verify that skills and agents are registered and ready to use.
sidebar:
  order: 1
---
...
2.  **Restart OpenCode**
    ...
    Restart your OpenCode session to load the new plugin. Systematic uses OpenCode's `config` hook to automatically register all bundled skills and agents.
...
- [Configure the plugin](/systematic/getting-started/configuration/) to disable specific bundled content.
- Explore the [architecture](/systematic/guides/architecture/) to understand how Systematic works under the hood.

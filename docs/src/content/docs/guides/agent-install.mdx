...
description: Machine-readable installation guide for Systematic — structured for AI agents to follow when setting up the plugin in a new environment.
sidebar:
  order: 3
---
...
- **Explore Assets**: Browse the [available skills](/systematic/reference/skills/) and [agents](/systematic/reference/agents/).

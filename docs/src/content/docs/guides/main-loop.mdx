...
-   **Multi-Agent Audit:** Agents like [`@security-reviewer`](/systematic/reference/agents/security-reviewer/) and [`@architecture-strategist`](/systematic/reference/agents/architecture-strategist/) scan for vulnerabilities and design flaws.

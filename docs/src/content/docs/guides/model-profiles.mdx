...
- **A project-defined name can never shadow one you already defined.** Bundle lookup checks custom, then user, then project last. If your `personal` profile and a repository's `personal` profile both exist, yours always wins.

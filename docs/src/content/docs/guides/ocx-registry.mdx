...
```bash
# Add the brainstorming workflow skill
ocx add systematic/brainstorming

# Add the planning workflow skill
ocx add systematic/ce-plan
```
...
```bash
# Install all 50 Systematic skills
ocx add systematic/skills

# Install all 29 Systematic agents

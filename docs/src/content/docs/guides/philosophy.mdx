...
description: The philosophy behind Systematic — why engineering effort should compound over time, and how the brainstorm-plan-work-review loop makes it happen.
sidebar:
  order: 1
---
